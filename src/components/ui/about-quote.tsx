        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы создали PromptCraft с одной идеей: каждый человек заслуживает инструмента, который превращает его замысел в реальный продукт. Не требуя знания кода, не требуя дизайнера, не требуя месяцев разработки.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Будь то стартап в поиске своей первой аудитории, агентство, масштабирующее производство, или предприниматель с идеей в голове — PromptCraft даёт вам скорость и свободу в эпоху ИИ.
            </p>
          </div>
        </div>
      </div>

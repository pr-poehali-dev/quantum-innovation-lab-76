      ...
      >
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              ...
              <p className="mb-8 mx-auto max-w-2xl text-pretty leading-relaxed text-gray-300 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-thin font-open-sans-custom tracking-wide leading-7 text-xl">
                PromptCraft превращает ваши слова в готовые интерфейсы — без кода,{" "}
                <span className="font-serif italic">без дизайнера</span>, без ожидания
              </p>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl">
            <div className="mx-auto mb-10 max-w-2xl text-center">
              ...
              <p className="text-gray-300 mt-4 text-sm md:text-base font-open-sans-custom [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)]">
                Мы убрали барьер между идеей и готовым продуктом — для всех и навсегда.
              </p>
            </div>
            <AboutQuote />
          </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl mt-[5vh]">
            <ContactCard
              title="Напишите нам"
              description="Хотите попробовать PromptCraft или есть вопросы? Оставьте заявку — мы ответим в течение нескольких часов и поможем подобрать подходящий план."
              contactInfo={[
                {
                  icon: MailIcon,
                  label: "Почта",
                ...
                },
                {
                  icon: MapPinIcon,
                  label: "Локация",
                  value: "Москва · удалённо по всему миру",
